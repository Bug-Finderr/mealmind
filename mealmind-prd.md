...
| F2 | Ingredient Input (Photo) | Take photo, AI extracts ingredients | Photo → AI → editable ingredient list |
| F3 | AI Recipe Generation | Generate recipe from ingredients | Returns complete recipe with steps, times |
...
colors: {
  ...
  secondary: "amber-100",     // Backgrounds
